...
class CustomPostType{
    ...
    private function buildTypeObject($singular, $plural, $public = true, $options = array() ){
        ...
        $args = array(
            ...
            'supports'            => isset($options['supports']) ? $options['supports']: array('title','editor','thumbnail'), //array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields')
